		...
		<v-card-text class="px-1 px-sm-3 px-md-6">
			<v-form v-model="valid">
					...
					<v-row justify="center">
						<v-col cols="12" class="py-0">
							<v-subheader class="pl-0"
								>Adresse de la location</v-subheader
							>
							<v-text-field
								v-model="form.adress"
                ...
                :rules="[v => !!v]"
						...
						<v-col cols="12" class="py-0">
							<v-row
								v-for="(tenant, index) in form.tenants"
								:key="index"
							>
								<v-col cols="12" sm="4" class="py-0">
									<v-subheader class="pl-0"
										>Civilité</v-subheader
									>
									<v-select
										:items="civilities"
										hide-details
                ...
                :rules="[v => !!v]"
						...
						<v-col cols="12" md="6" class="py-0">
							<v-subheader class="pl-0"
								>Montant des charges</v-subheader
							>
							<v-text-field
								placeholder="80"
