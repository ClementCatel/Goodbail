  ...
  <v-container fluid fill-height class="py-0 px-md-0">
    <v-row class="h-100" align="center">
      <v-col cols="12" lg="6" class="px-0 py-12">
        ...
        >
          <v-card-title class="display-1 font-weight-black justify-center py-4">
            Goodbail
          </v-card-title>
            ...
            <app-card class="my-auto">
              ...
              <v-card-text class="px-2 px-md-10 py-6">
                <div class="d-flex flex-row">
                  ...
                  >
                  <p class="mb-0">
                    <b>Ouvrez votre compte Goodbail.</b> Votre email nous
                    servira seulement d'identifiant pour votre compte, Aucun
                    email publicitaire ne seront envoyé.
                  </p>
                </div>
                <div class="hr"></div>
                <div class="d-flex flex-row">
                  ...
                  >
                  <p class="mb-0">
                    Enregistrez les informations concernant votre/vos bien(s)
                    locatif(s).
                  </p>
                </div>
                <div class="hr"></div>
                <div class="d-flex flex-row">
                  ...
                  >
                  <p class="mb-0">
                    Remplissez notre formulaire pour générer votre quittance de
                    loyer au format PDF.
                    <b
                      >Pour les prochaines fois, votre document sera
                      automatiquement rempli et daté.</b
                    >
                  </p>
                </div>
                <div class="hr"></div>
                <div class="d-flex flex-row">
                  ...
                  <p>
                    ...
                    <b>générer votre quittance de loyer en 1 clic.</b>
                  </p>
                </div>
              </v-card-text>
            </app-card>
