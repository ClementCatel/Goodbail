...
export const INVALID_CREDENTIAL =
  "Hum, on dirait que votre mot de passe est incorrect, veuillez réessayer !";
export const INVALID_EMAIL_FORMAT =
  "Il semble que votre adresse email soit erronée.";
export const INVALID_PASSWORD_FORMAT =
  "Veuillez saisir un mot de passe d'au moins 6 caractères.";
export const DEFAULT_MESSAGE = "Une erreur s'est produite, veuillez réessayer.";
export const REQUIRES_RECENT_LOGIN =
  "Ceci est une opération sensible et requiert une authentification récente. Veuillez vous reconnecter avant d'effectuer cette action.";
